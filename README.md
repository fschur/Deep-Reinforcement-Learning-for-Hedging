...
> [**Hedging using reinforcement learning: Contextual k-Armed Bandit versus Q-learning**](https://arxiv.org/abs/1902.06278)<br/>
> Loris Cannelli, Giuseppe Nuti, Marzio Sala, Oleg Szehr

and 

> [**Dynamic Replication and Hedging: A Reinforcement Learning Approach**](https://www.semanticscholar.org/paper/Dynamic-Replication-and-Hedging%3A-A-Reinforcement-Kolm-Ritter/4422b5a01f95aacafc443c2612df55cd494fad14)<br/>
