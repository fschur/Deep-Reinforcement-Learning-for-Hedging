...
num_actions = 21
model = space_bandits.NeuralBandits(num_actions, 3, layer_sizes=[20, 20], initial_pulls=20, lr_decay_rate=0.5,
                                    reset_lr=True, do_scaling=True, buffer_s=10000, initial_lr=0.1, training_freq=1,
