...
num_actions = 21
model = space_bandits.NeuralBandits(num_actions, 3, layer_sizes=[20, 20], initial_pulls=20, lr_decay_rate=0.9999,
                                    reset_lr=False, do_scaling=True, initial_lr=0.1, training_freq=1,
