...
num_actions = 21
model = space_bandits.NeuralBandits(num_actions, 2, layer_sizes=[20, 20], initial_pulls=100,
                                    lr_decay_rate=0, initial_lr=0.0005, reset_lr=False, memory_size=50000,
...
def test(model, apm, opm, num_steps, dt, n):
...
model.save("bnn_lr_diff_3_model")
