...
num_actions = 21
model = space_bandits.NeuralBandits(num_actions, 2, layer_sizes=[20, 20], lr_decay_rate=1/20, initial_pulls=10000,
                                    reset_lr=True, training_freq=1000, training_freq_network=10000,
                                    training_epochs=20000, memory_size=100000)
