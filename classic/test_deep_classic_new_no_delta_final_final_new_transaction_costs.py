...
plt.xlabel("loss")
plt.legend()
plt.savefig("test_deep_classic_new_no_delta_losses_final_new.png")

torch.save(model, "model_classic_final_new.pth")
...
for i in range(5):
    ...
    plt.xlabel("time")
    #plt.xlabel("")
    plt.savefig("test_deep_classic_new_no_delta_final_new" + str(i) + ".png")
    plt.show()
    plt.clf()
    plt.cla()
    plt.close()
